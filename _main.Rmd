...
```{r child = './sections/00-intro.Rmd'}
rmarkdown::render('./sections/00-intro.Rmd')
```
...
```{r child = './sections/01-data.Rmd'}
```

-------------------------------
# 2.	EDA

```{r child = './sections/02-EDA.Rmd'}
```
...
```{r child = './sections/04-neighborhoods.Rmd'}
```
----------------------------------
...
<!--chapter:end:MUSA508_HW2_BOULDER.Rmd-->
