...
add_v = function(vnme, vnum, vtype){
  if(vnme %in% boulder.variables$var_name){print("didnt add since it is already in")}
  else{
...
### 1.A.8 Assorted Variable Creation
...
# 1. Num of Bedrooms
boulder.variables = rbind(boulder.variables,c(
