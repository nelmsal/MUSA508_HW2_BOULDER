...
corrPlotVariables <- boulder.predict.0 %>%
  dplyr::select(boulder.dv) %>% st_drop_geometry(.)
...
ggplot(data = boulder.predict, aes(x = PREDICTOR VARIABLE, y = SalePrice)) +
...
ggplot() +
  ...
  geom_sf(data = boulder.predict, aes(colour = q5(SalePrice))) +
...
ggplot() +
  geom_sf(data = XXXX, fill = "gray80", colour = "white") +
  geom_sf(data = XXXX, fill = "XXXXX", colour = "XXXXXX") +
  geom_sf(data = boulder.predict, aes(colour = q5(XXXXXX))) +
  scale_colour_manual(values = paletteMap) +
  labs(title = "XXXXXXXX", subtitle = "XXXXXXX") +
  mapTheme()
...
ggplot() +
  geom_sf(data = XXXX, fill = "gray80", colour = "white") +
  geom_sf(data = XXXX, fill = "XXXXX", colour = "XXXXXX") +
  geom_sf(data = boulder.predict, aes(colour = q5(XXXXX))) +
  scale_colour_manual(values = paletteMap) +
  labs(title = "XXXXXXXX", subtitle = "XXXXXXX") +
  mapTheme()
...
ggplot() +
  geom_sf(data = XXXX, fill = "gray80", colour = "white") +
  geom_sf(data = XXXX, fill = "XXXXX", colour = "XXXXXX") +
  geom_sf(data = boulder.predict, aes(colour = q5(XXXX))) +
  scale_colour_manual(values = paletteMap) +
  labs(title = "XXXXXXXX", subtitle = "XXXXXXX") +
  mapTheme()
